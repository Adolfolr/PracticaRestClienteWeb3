...
//        Agenda a = agendaServicio.getXml(Agenda.class);
            ...
            AgendaServicio agendaServicio = new AgendaServicio();
            Agenda a = agendaServicio.getXml(Agenda.class);
            String valido = validarAgenda.postXML(a);
            
            /* TODO output your page here. You may use following sample code. */
            out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ValidarAgenda</title>");            
            out.println("</head>");
            out.println("<body>");
            if (valido.equals("--------\n La agenda es válida \n--------")) {
                out.println("<h1>La agenda es válida</h1>");
            }else{
                out.println("<h1>La agenda no es válida</h1>");
            } 
            out.println("</body>");
            out.println("</html>");
        }

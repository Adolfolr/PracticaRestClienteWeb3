...
public class MostrarAgenda extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MostrarAgenda</title>");            
            out.println("</head>");
            out.println("<h1>Los contactos de tu agenda:</h1>");
            out.println("<body>");
            for(Persona p : a.getPersonas()){
                out.println("Nombre:"+p.getNombre()+"<br>"); 
                out.println("Telefono: " + p.getTelefono()+"<br>");
                out.println("Email: " + p.getEmail()+"<br>");
                out.println("--------------"+"<br>");
            }
            out.println("</body>");
            out.println("</html>");
